	...
	'Login':{
		...
		'Create':function($id){
			...
			if(MAC.Cookie.Get('userid')!=undefined && MAC.Cookie.Get('userid')!=''){ 
				html+='<ul class="logged"><li><a target="_blank" href="'+SitePath+'index.php?m=user-index">个人信息</a></li><li><a target="_blank" href="'+SitePath+'index.php?m=user-info.html">修改资料</a></li><li><a target="_blank" href="'+SitePath+'index.php?m=user-fav.html">我的收藏</a></li><li><a target="_blank" href="'+SitePath+'index.php?m=user-plays.html">播放记录</a></li><li><a target="_blank" href="'+SitePath+'index.php?m=user-pay.html">会员充值</a></li><li><a target="_blank" href="'+SitePath+'index.php?m=user-upgrade.html">会员升级</a></li><li class="logout"><a class="logoutbt" href="javascript:;" onclick="MAC.Login.Out(\''+$id+'\');" target="_self"><i class="ui-icon user-logout"></i>退出</a></li></ul>';
			}
			else{
				html+='<form id="loginform" onsubmit="return false;" action="'+SitePath+'index.php?user-check" method="post"><div class="formitem"><label>用户 :</label><input name="username" type="text"  class="input" id="username"/></div><div class="formitem"><label>密码 :</label><input name="userpass" type="password" class="input" id="userpass"/></div><div class="formitem"> <input class="formbutton" id="loginbtn" type="submit" value="登 录"></div><div class="formitem"><a title="忘记密码" class="forgotpass" href="'+SitePath+'index.php?m=user-findpass.html">忘记密码?</a>  <a class="reg-btn" href="'+SitePath+'index.php?m=user-reg.html" target="_blank">还没有账号?</a></div></form>';
			}
			...
			$('#login_box').css({'right':position.left,'top':38});
		},
		'Out':function($id){
